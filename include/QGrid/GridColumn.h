...
class QGRID_EXPORT GridColumn : public QObject {
  Q_OBJECT

  Q_FLAGS(Operations)

  Q_PROPERTY(QString header READ getHeader WRITE setHeader)
  ...
  Q_PROPERTY(bool isId READ getIsId WRITE setIsId)
  Q_PROPERTY(bool isParentId READ getIsParentId WRITE setIsParentId)
  Q_PROPERTY(bool editable READ getEditable WRITE setEditable)
  Q_PROPERTY(bool showInStaticFilter READ getShowInStaticFilter WRITE setShowInStaticFilter)
  Q_PROPERTY(bool showInSearchBar READ getShowInSearchBar WRITE setShowInSearchBar)
...
public:
  ...
  bool getDirectEdit() const;
  void setDirectEdit(bool value);
